 ...
 */
public class ConsumeRequestClient {
    public static void main(String[] args) throws Exception {

        SystemUtil.echoSystemDefaultEncoding();

        consumeRequest("application/json", "ISO-8859-1");
        consumeRequest("application/json", null);//将会使用OS系统缺省编码

    }

    private static void consumeRequest(String mimeType, String charsetName) throws Exception {
        //请求的地址
        String url = "http://localhost:8080/consume/request";
